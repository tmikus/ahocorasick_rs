...
// if the prefilter is observed to be suboptimal for a particular workload.
//
...
// Other automatons, like the DFA, require two copies of the underlying transition table to support both simultaneously.
//
